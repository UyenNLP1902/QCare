...
public class AuthFilter implements Filter {
    ...
    public AuthFilter() {
        guest = new ArrayList<>();
        guest.add("");
        guest.add("Login_PageAction");
        guest.add("Login_PageAction.action");
        guest.add("Search_PageAction");
        guest.add("Search_PageAction.action");
        ...
        try {
            ...
            if (session == null || session.getAttribute("ACCOUNT") == null) {
                ...
                if ((account.getRole() == ROLE_ADMIN && admin.contains(resources))
                        || ((account.getRole() == ROLE_DOCTOR || account.getRole() == ROLE_PATIENT)
